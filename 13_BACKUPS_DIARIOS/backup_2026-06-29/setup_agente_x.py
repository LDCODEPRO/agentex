...
modules_to_check = [
    ...
    # M3: Learning
    ROOT / "01_CORE" / "orchestrator" / "learning_loop.py",
    # M5-M6: Skills
    ROOT / "04_SKILLS" / "skill_manager.py",
    ROOT / "04_SKILLS" / "hermes_core.py",
    ROOT / "04_SKILLS" / "hermes_knowledge_seeder.py",
    # M6: Mission Engine
    ROOT / "01_CORE" / "mission_engine" / "mission_brain.py",
    ROOT / "01_CORE" / "mission_engine" / "mission_engine.py",
    ROOT / "01_CORE" / "mission_engine" / "mission_executor.py",
    ROOT / "01_CORE" / "mission_engine" / "mission_planner.py",
    ROOT / "01_CORE" / "mission_engine" / "mission_templates.py",
    ROOT / "01_CORE" / "mission_engine" / "mission_validator.py",
    ROOT / "01_CORE" / "mission_engine" / "rollback_engine.py",
    # M6: WhatsApp
    ROOT / "06_CONTAINERS" / "whatsapp" / "whatsapp_agent.py",
    # Reports & Diagnostics
    ROOT / "10_GITHUB" / "save_manager.py",
    ROOT / "10_GITHUB" / "daily_report_generator.py",
    ROOT / "agente_x.py",
    ROOT / "agente_diagnostico.py",
    # M8: Health & Observability
    ROOT / "05_HEALTH" / "health_monitor.py",
    ROOT / "05_HEALTH" / "performance_tracker.py",
    ROOT / "05_HEALTH" / "auto_tuner.py",
]
